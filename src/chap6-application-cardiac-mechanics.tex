...
\centering
\subfigure[]{%
		\includegraphics[scale=0.088]{media/4-cardioid/2-activationtime.png}
\label{fig:supp1}}
\subfigure[]{%
		\includegraphics[scale=0.088]{media/4-cardioid/3-fibers.png}
\label{fig:supp2}}
\subfigure[]{%
...
\centering
\subfigure[]{%
		\includegraphics[scale=0.06]{media/4-cardioid/6-vid/a.png}
\label{fig:snaps1}}		
\subfigure[]{%
		\includegraphics[scale=0.06]{media/4-cardioid/6-vid/b.png}
\label{fig:snaps2}}		
\subfigure[]{%
		\includegraphics[scale=0.06]{media/4-cardioid/6-vid/c.png}
\label{fig:snapsf3}}		
\subfigure[]{%
		\includegraphics[scale=0.06]{media/4-cardioid/6-vid/d.png}
\label{fig:snaps4}}		
%
