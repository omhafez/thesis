...
\acknowledgments{\noindent
Professor Mark Rashid \\
Cardioid group David Richards, Robert Blake, Jean-Luc Fattebert \\
Viatcheslav Gurev at IBM \\
Andrew Baldwin and Alipasha Sadri at Celeris \\
IBBM \\

Krell Institute and CSGF \\
Floyd and Mary Schwall \\
Eugene Cota Robles \\
Department of Civil and Environmental Engineering  \\
Professor Sashi Kunnath and Professor Amit Kanvinde \\

Professor John Bolander \\
Professor Yannis Dafalias \\
James Stolken and Ryan Vignes \\
All of the instructors for which I took classes \\

ENG 104 students and Bryan Zhao \\

Steven Wopschall \\
Brian Giffin \\
Sam Mish \\
Vince, Eric, Jit, Alex, CMWG \\
Rose McCallen \\
My father \\
My mother \\
My friends \\
...
Sabah \\
Mo \\
Farhan, Hassan, Sule, Dan \\
Ameer \\
Vipul, Arash, Sammi, Sabil \\
Asmaa and her family \\
}
