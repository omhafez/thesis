...
The toolchain used to performing image-based cardiac mechanics simulations makes important improvements to the speed and robustness of image-based modeling techniques. As efforts continue to mature, so too does the promise for simulation to impact and improve healthcare.}
