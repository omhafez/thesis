...
\documentclass[12pt, nofigureslist, notableslist]{ucdavisthesis}
...
Many thanks to Professors Rob MacLeod, Jeffrey Weiss, and Ross Whitaker at the University of Utah for organizing and accepting me into their summer course on Image-Based Biomedical Modeling. The two weeks at that course was easily one of the most intense, enjoyable, and memorable periods of time during my PhD.

I have many people to thank for providing me the financial support needed to complete this degree. I am forever indebted to Professor Mark Rashid and David Richards; the Krell Instititute and the Computational Science Graduate Fellowship; Floyd and Mary Schwall; those in charge of the Eugene Cota Robles Fellowship; the UC Davis Department of Civil and Environmental Engineering; and Professors Sashi Kunnath, Amit Kanvinde, and John Bolander for giving me the means to accomplish my goals.

Thank you to Professors John Bolander, N. Sukumar, and Yannis Dafalias for their guidance and mentorship over all these years dating back to my Master's Degree. Thank you to James Stolken and Ryan Vignes at Lawrence Livermore National Laboratory for their knowledge and wisdom during a period when I was first trying to fully understand what it meant to do good research.
...
Thank you to my officemates Steven Wopschall and Brian Giffin for giving me something to look forward to every day at the office. I will forever cherish the impact they have had on my life. Likewise, thank you to my roommate during the Image-Based Biomedical Modeling course Brett Steinemann, for whom I share the same sentiments.

Many thanks to Vince Pericoli, Eric Chin, Jit Banerjee, and Alex Petalas for helping Steve and I organize our student group, and Rose McCallen for her endless supply of enthusiasm, advice, and connections.
...
My love and thanks are extended to my mother, my father, and my brothers, who gave me the comfort and motivation to stay the course even through the most difficult times. My deepest thanks to Asmaa Hassanein for being my rock, for helping me find my center again, and for believing in me.
...
\include{chap1-overview}
\include{chap2-medical-imaging-and-image-segmentation}
\include{chap3-image-based-meshing}
\include{chap4-numerical-methods}
\include{chap5-application-cardiac-mechanics}
\include{chap6-future-work}
\include{chap7-conclusions}
\phantomsection
\addcontentsline{toc}{chapter}{\hspace{6.5mm}References}
\bibliography{references}

% The UMI abstract uses square brackets!
\UMIabstract[Image-based modeling and simulation has become an important analytic and predictive tool for patient-specific medical applications, including large-scale in-silico patient studies; optimized medical device design; and custom surgical guides and implants via additive manufacturing. The pipeline of steps for patient-specific modeling and simulation are: image acquisition, image segmentation, mesh generation, numerical simulation, and finally clinical application. Novel approaches to the mesh generation and numerical methods steps are described, that offer improvements toward automation of the toolchain. The workflow is demonstrated by modeling a beating human heart based on MRI data.
