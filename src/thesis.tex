...
\committee{Mark Rashid}{Natarajan Sukumar}{John Bolander}{}{}
...
\include{chap3-surface-generation}
\include{chap4-mesh-generation}
\include{chap5-numerical-methods}
\include{chap6-application-cardiac-mechanics}
\include{chap7-future-work}
\include{chap8-conclusions}
