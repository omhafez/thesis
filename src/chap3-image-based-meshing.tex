...
The zeroth, first, and second moments of volume of $\Omega$ are defined in the same manner, with integrals performed over the domain of $\Omega$ instead. For the purposes of computing an error functional, define the following quantities:
\begin{alignat}{3}
...
\centering
\subfigure[]{%
		\includegraphics[scale=0.13]{media/3-celeris/zoom/zoom1.png}
\label{fig:zoom1}}		
\hfill
\subfigure[]{%
		\includegraphics[scale=0.13]{media/3-celeris/zoom/zoom2.png}
\label{fig:zoom2}}		
\hfill
\subfigure[]{%
		\includegraphics[scale=0.13]{media/3-celeris/zoom/zoom3.png}
\label{fig:zoom3}}		
\subfigure[]{%
		\includegraphics[scale=0.13]{media/3-celeris/zoom/zoom4.png}
\label{fig:zoom4}}	
\hfill
\subfigure[]{%
		\includegraphics[scale=0.13]{media/3-celeris/zoom/zoom5.png}
\label{fig:zoom5}}		
\hfill
\subfigure[]{%
		\includegraphics[scale=0.13]{media/3-celeris/zoom/zoom6.png}
\label{fig:zoom6}}	
...
\begin{figure}[htbp!]
\centering
		\includegraphics[scale=0.27]{media/comparison.png}
%\subfigure[]{%
